...
class SimpleL2Cache(parentName: String = "L2_")(implicit p: Parameters) extends LazyModule with HasL2Param {
    ...
    class Impl extends LazyModuleImp(this) {
        val io = IO(new Bundle {
            ...
            val chi         = new CHIBundleDownstream_1(chiBundleParams) // compatible with kmh
...
object SimpleL2Cache extends App {
    ...
    val top = DisableMonitors(p => LazyModule(new SimpleL2CacheWrapper(nrCore = 2, nrSlice = 2, nodeID = 12)(p)))(config)
