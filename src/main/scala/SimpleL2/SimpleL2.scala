...
class SimpleL2CacheWrapperDecoupled(nrCore: Int = 1, nrSlice: Int = 1, sets: Option[Int] = None, ways: Option[Int] = None, idRangeMax: Int = 16, nodeID: Int = 0)(implicit p: Parameters) extends LazyModule {
    val cacheParams = p(L2ParamKey)
...
object SimpleL2CacheDecoupled extends App {
    ...
    val top = DisableMonitors(p => LazyModule(new SimpleL2CacheWrapperDecoupled(nrCore = 1, nrSlice = 2, idRangeMax = 64, nodeID = 12)(p)))(config)
